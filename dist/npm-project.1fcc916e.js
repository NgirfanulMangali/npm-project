...
const dateUser = (0, _dayjsDefault.default)().format("dddd,D MMMM,YYYY");
...
form.addEventListener('submit', (e)=>{
    ...
    function time() {
        const now = (0, _dayjsDefault.default)().tz(selectedZone).format('hh:mm:ss A');
...
function time() {
    const now = (0, _dayjsDefault.default)().format('hh:mm:ss A');
    zone2.textContent = now;
}
time();
intervalId = setInterval(time, 1000);

},{"dayjs":"7jGxJ","micromodal":"fpXyP","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","dayjs/plugin/utc":"g0vMZ","dayjs/plugin/timezone":"7hEII"}],"7jGxJ":[function(require,module,exports,__globalThis) {
!function(t, e) {
    module.exports = e();
}(this, function() {
    "use strict";
...
},{}],"g0vMZ":[function(require,module,exports,__globalThis) {
!function(t, i) {
    module.exports = i();
}(this, function() {
    "use strict";
...
},{}],"7hEII":[function(require,module,exports,__globalThis) {
!function(t, e) {
    module.exports = e();
}(this, function() {
    "use strict";
...
},{}]},["iUuJv","fILKw"], "fILKw", "parcelRequire2372", {})

//# sourceMappingURL=npm-project.1fcc916e.js.map
